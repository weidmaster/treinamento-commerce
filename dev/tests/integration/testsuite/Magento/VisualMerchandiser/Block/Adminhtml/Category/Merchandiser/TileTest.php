...
class TileTest extends TestCase
{
    ...
    private const FIRST_WEBSITE_STORE = 1;
    private const SECOND_WEBSITE_FIRST_STORE = 2;
    private const SECOND_WEBSITE_SECOND_STORE = 3;
    ...
    protected function tearDown(): void
    {
        ...
        $cache->remove(Cache::CACHE_PREFIX . $this->positionCacheKey);
