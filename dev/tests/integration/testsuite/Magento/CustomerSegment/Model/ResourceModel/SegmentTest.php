...
class SegmentTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function createConditionSqlDataProvider()
    {
        return [
            ...
            'Operator is array with strings (multiselect, equals)' => [
                'value',
                'finset',
                ['VIP Group', 'Premium Group'],
                'FIND_IN_SET(\'VIP Group\', value)>0 AND FIND_IN_SET(\'Premium Group\', value)>0 AND 23=LENGTH(value)',
            ],
            'Operator is array with strings (multiselect, contains)' => [
                'value',
                '[]',
                ['VIP Group', 'Premium Group'],
                '(FIND_IN_SET(\'VIP Group\', value) OR FIND_IN_SET(\'Premium Group\', value))>0',
            ],
