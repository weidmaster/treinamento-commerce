...
class ProductWithMultiSelectAttributeImportJsonApiTest extends WebapiAbstract
{
    private const RESOURCE_PATH = '/V1/import/json';

    /**
     * Test Rest API Product Import with Custom Attribute - Type Multiselect
     *
     ...
     */
    public function testMultiSelectAttributeProductImport(array $requestData, array $expectedResponse): void
    {
            ...
            [
                'requestData' => [
                    'source' => [
                        ...
                        'allowedErrorCount' => '0',
                        'items' => __DIR__ . '/_files/simple_product_with_multiselect_attribute.json'
                    ]
                ],
                'expectedResponse' => [
    ...
    {
        $productsToRemove = [
            'Simple Product with Custom Multiselect Attribute'
        ];
