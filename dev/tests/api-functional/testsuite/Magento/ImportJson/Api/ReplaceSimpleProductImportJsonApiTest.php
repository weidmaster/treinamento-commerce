...
class ReplaceSimpleProductImportJsonApiTest extends WebapiAbstract
{
    private const RESOURCE_PATH = '/V1/import/json';

    /**
     * Test Rest API Product Import with Replace behavior
     *
     ...
     */
    public function testSimpleProductReplaceByImport(array $requestData, array $expectedResponse): void
    {
            ...
            [
                'requestData' => [
                    'source' => [
                        ...
                        'allowedErrorCount' => '0',
                        'items' => __DIR__ . '/_files/simple_product_replace.json'
                    ]
                ],
                'expectedResponse' => [
