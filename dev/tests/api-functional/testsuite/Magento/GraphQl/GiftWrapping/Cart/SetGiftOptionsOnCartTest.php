...
QUERY;
    ...
    public function testLoggedInCustomerTryingToSetGiftOptionsToOwnCart()
    {
        ...
        //Unset the gift message that previously set
        $unsquery = $this->getUnSetGiftOptionsOnCartQuery($quoteId);
        $unsGiftOptionsResponse = $this->graphQlMutation(
            $unsquery,
            [],
            '',
            $headerAuthorization
        );
        $unsGiftOptionsResponse = $unsGiftOptionsResponse['setGiftOptionsOnCart']['cart'];
        $this->assertNull($unsGiftOptionsResponse['gift_message']);
    }
...
QUERY;
    ...
    /**
     * Create the unsetGiftOptionsOnCar query
     *
     * @param string $quoteId
     * @return string
     */
    private function getUnSetGiftOptionsOnCartQuery(string $quoteId): string
    {
        return  <<<QUERY
          mutation{
            setGiftOptionsOnCart(input: {
